...
(`/dev/skills/docs/build-process.md` §Quality Checkpoint) prescribes four
...
- **Target scope:** what the user specifies after the slash command
  ...
  `docs/architecture/roadmap.md`. If no roadmap exists, fall back to
...
1. `docs/architecture/roadmap.md` (if it exists) — find the latest ✅ DONE phase
2. `/dev/skills/docs/build-process.md` §Quality Checkpoint — the canonical methodology
